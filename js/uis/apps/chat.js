export default class ChatApp extends HTMLElement {
    ...
    return /* html */`
      <ul class="tabs">
        <li class="tab active">
          ...
          <span class="count">${this.app.utils.format(this.getAttribute("all"))}</span>
        </li>
        <li class="tab">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none">
          ...
          <span class="count">${this.app.utils.format(43)}</span>
        </li>
        <li class="tab">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none">
          ...
          <span class="count">${this.app.utils.format(3)}</span>
        </li>
      </ul>
    `;
  }
  ...
  getPinnedChats = () => {
    return /* html */`
      <div is="pin-chat" user-picture="https://randomuser.me/api/portraits/women/2.jpg"
      ...
      <div is="pin-chat" user-picture="https://randomuser.me/api/portraits/men/61.jpg"
        user-name="John Smith" unread="5" active="true" last-message="See you tomorrow"
        is-even="false" user-verified="true">
      </div>
      <div is="pin-chat" user-picture="https://randomuser.me/api/portraits/men/46.jpg"
        user-name="Bob Brown" unread="0" active="false" last-message="Let's catch up later"
        is-even="false">
      </div>
      <div is="pin-chat" user-picture="https://randomuser.me/api/portraits/men/15.jpg"
        user-name="Charlie Davis" unread="3" active="true" last-message="I'll be there soon"
        is-even="true">
      </div>
      <div is="pin-chat" user-picture="https://randomuser.me/api/portraits/women/16.jpg"
        user-name="Diana Evans" unread="4" active="false" last-message="Can you send the file?"
        is-even="false" user-verified="true">
      </div>
      <div is="pin-chat" user-picture="https://randomuser.me/api/portraits/men/71.jpg"
  ...
  getChats = () => {
    return /* html */`
      <div is="chat-item" user-picture="https://randomuser.me/api/portraits/women/2.jpg"
        ...
        user-profession="Engineer" user-company="Safaricom PLC"
        attachments='[
          {
      ...
      <div is="chat-item" user-picture="https://randomuser.me/api/portraits/women/71.jpg"
      ...
      user-profession="Software Developer" user-company="Equity Bank">
      </div>
      ...
      user-profession="Regional Manager" user-company="Kenya Commercial Bank"
      ...
      <div is="chat-item" user-picture="https://randomuser.me/api/portraits/men/61.jpg"
      ...
      user-profession="Sales" user-company="Airtel Kenya">
      </div>
      <div is="chat-item" user-picture="https://randomuser.me/api/portraits/women/91.jpg"
      ...
      user-profession="Receptionist" user-company="Co-operative Bank">
      </div>
      ...
      user-profession="Marketing Executive" user-company="Bamburi Cement">
      </div>
      ...
      user-profession="HR Manager" user-company="Kenya Airways">
      </div>
      ...
      user-profession="Farm Manager" user-company="Kakuzi PLC">
      </div>
      ...
      user-profession="Fashion Designer" user-company="Naivas Supermarket">
      </div>
      ...
      user-profession="Business Analyst" user-company="Standard Chartered Bank">
      </div>
      ...
      user-profession="Customer Service Rep" user-company="Britam Holdings">
      </div>
      ...
      user-profession="Finance Manager" user-company="East African Breweries">
      </div>
      ...
      user-profession="Event Coordinator" user-company="Nation Media Group">
      </div>
    `;
  }
