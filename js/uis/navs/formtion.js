      ...
      <li class="nav-item meetings" data-nav="meetings">
        <div class="link">
          <a href="/formation/meetings">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" color="currentColor" fill="none">
              <path d="M21 10H16L15 7H9L8 10H3L4 16H20L21 10Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" />
              <path d="M8 10V5C8 3.89543 8.89543 3 10 3H14C15.1046 3 16 3.89543 16 5V10" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" />
              <path d="M8 16V19C8 20.1046 8.89543 21 10 21H14C15.1046 21 16 20.1046 16 19V16" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" />
            </svg>
