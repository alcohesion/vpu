export default class RevenueAccount extends HTMLElement {
  constructor() {
  ...
  initStats = () => {
    const last = {
      earned: this.utils.number.parse(this.getAttribute("last-earned")),
      transferred: this.utils.number.parse(this.getAttribute("last-transferred"))
    };

    const current = {
      earned: this.utils.number.parse(this.getAttribute("current-earned")),
      transferred: this.utils.number.parse(this.getAttribute("current-transferred"))
    }
    ...
    return {
      ...
      transferred: this.calculatePercentage(current.transferred, last.transferred)
    }
  }
  ...
  getInfo = () => {
    ...
    return /* html */`
      <div class="account">
        <span class="info">
          <span class="text">Revenue Account</span>
      ...
      <div class="section stats">
        <div class="overview">
          <div class="stat earned">
            ...
            <div class="details">
              <div class="amount">
                <span class="number">${this.utils.number.balanceWithCommas(current.earned)}</span>
                <span class="currency">EAC</span>
              </div>
          ...
          <div class="stat transferred">
            <h2 class="text">Transferred</h2>
            <div class="details">
              <div class="amount">
                <span class="number">${this.utils.number.balanceWithCommas(current.transferred)}</span>
                <span class="currency">EAC</span>
              </div>
              <div class="change ${transferred.rise ? "rise" : "fall"}">
                <span class="icon">
                  ${transferred.rise ? this.getUpIcon() : this.getDownIcon()}
                </span>
                <span class="text">${transferred.percentage}%</span>
              </div>
              <div class="info">
                <span class="text">*In the last 30 days</span>
              </div>
