export default class RecoverSuccess extends HTMLElement {
  constructor() {
  ...
  getBody = () => {
    return /* html */`
      <div class="registered">
        ...
        <div class="top">
          <h4 class="title">Recovered Successfully.</h4>
          <p class="desc">
            Dear <b>${this.getAttribute("name")}</b>, your password has been successfully reset.
