export default class RecoverVerify extends HTMLElement {
  constructor() {
  ...
  connectedCallback() {
    ...
    this.generateCode();
    this.addCountDown(this.querySelector('.phone-header > .actions > .action'), 60);
  }
      ...
      <form class="fields initial" id="name-form">
        <div class="field">
          <div class="input-group code">
            ...
            <input type="text" id="code" name="code" placeholder="Verification code e.g N5XF6U" required>
  ...
  getHeader = () => {
    return /* html */`
      <div class="phone-header">
        <div class="top">
          <h4 class="title">Provide Verification Code</h4>
          <p class="desc">
            Enter the code sent to your phone number or email to verify this is your account.
            <!--<br>Click the back button to change where you want the verification code to be sent, and click next to continue.-->
            <br>You can click <b>Resend code</b> button to request another code upon expiry of 60 seconds.
          </p>
        </div>
        <div class="actions">
          <button class="action" id="verify-phone">Resend code</button>
        </div>
      </div>
    `;
  }
  ...
  getButtons = () => {
    return /*html*/`
      <p class="info">Click the back button to change where you want the verification code to be sent. Click next to continue.</p>
      <div class="buttons">
