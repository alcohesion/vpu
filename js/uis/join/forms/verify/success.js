export default class VerifySuccess extends HTMLElement {
  constructor() {
  ...
  connectedCallback() {
    ...
    this.validateIdentity(container);
  }

  validateIdentity = container => {
  ...
  getBody = () => {
    return /* html */`
      <div class="verified">
        ...
        <div class="top">
          <h4 class="title">Verification success.</h4>
          <p class="desc">
            Dear <b>${this.getAttribute("name")}</b>, your email and phone number were successfully verified.
            <br>Click on the button below to proceed with identity verification process.
          </p>
        </div>
        <div class="actions">
