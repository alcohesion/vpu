export default class IdentityFront extends HTMLElement {
  constructor() {
    super();
  ...
  submitForm = form => {
    form.addEventListener('submit', async e => {
      ...
      if (upload.uploaded) {
        // set values to app
        this.app.setIdentityData({ front: upload.url });

        // navigate to next form
        this.app.navigate({ kind: 'identity', no: 4 });
      } else {
    ...
    return /* html */`
      <div class="content">
        <div class="top">
          ...
          <p class="desc">
            Click on <strong><i>Take Photo</i></strong> to capture a <b>front</b> view of your identity document.
            <br>Make sure the document is clear and all details are visible.
            You can <strong><i>Retake Photo</i></strong> if it is not looking good.
